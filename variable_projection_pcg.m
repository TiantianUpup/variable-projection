function runhist = variable_projection_pcg(U0,V0,MA,vp_paras,cg_paras,paras)
    timect = cputime;
    m = paras.m;
    n = paras.n;
    r = paras.r;
    ...
    while (iter < itmax && norm(gra(:))>tol)
        ...
        fprintf("-------- the calculate of the cofficient matrix costs %3.10f\n",cputime- timect_coff);
       ...
       %% check whether [A;B] is the descent direction
        ...
        fprintf("variable_projection_pcg %d-th iteration, fval is %3.20f =============================================================\n",iter,fval(U,V,MA_temp));
