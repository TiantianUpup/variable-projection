function runhist = cg_subproblem_simple_v3(Aparas,cg_paras,paras,B,gamma)
    timect = cputime;
    ...
    while (iter < itmax && R_norm > tol)
        ...
        % Step 3
        alpha = norm (R(:))^2 / trace(C' * Aope_simple_v3(Aparas, paras, C,gamma));
        ...
        % Step 5
        R_pre = R;
        R = R - alpha * Aope_simple_v3(Aparas, paras, C, gamma);
