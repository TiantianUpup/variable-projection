function runhist = variable_projection_simple_opt_v6(U0,V0,U_true,V_true,W_true,MA,vp_paras,cg_paras,paras)
    fprintf("---------------------------------------- variable_projection_simple_opt_v5 -------------------------------\n");
    timect = cputime;
    m = paras.m;
    n = paras.n;
    r = paras.r;
    ...
    while (iter < itmax)
        ...
        % runhist_X2 = X2_subproblem(Aparas, Z2, paras);
        % runhist_Y2 = Y2_subproblem(Aparas, Z4, paras);
        ...
        % runhist_X1_Y1 = fetchOutputs(f1);
        % runhist_X2 = fetchOutputs(f2);
        % runhist_Y2 = fetchOutputs(f3);    

       runhist_cell = cell(1, 3);
        ...
        parfor i = 1:3
            ...
            switch i
                case 1
                    temp_result = X1_Y1_subproblem(Aparas, B1, paras);
                case 2
                    temp_result = X2_subproblem(Aparas, Z2, paras);
                case 3
                    temp_result = Y2_subproblem(Aparas, Z4, paras);
            end
            runhist_cell{i} = temp_result;
        end


        runhist_X1_Y1 = runhist_cell{1};
        runhist_X2 = runhist_cell{2};
        runhist_Y2 = runhist_cell{3};
