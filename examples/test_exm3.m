...
% (Table 6).
%
% The factor matrix W is ill-conditioned and contaminated with noise.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for i=1:trial
    ...
    W_n=randn(p,r_true);
    rho_w=sigma*(norm(W_true(:))/norm(W_n(:)));
...
r_id = fopen('../results/rel_err_ex3.txt', 'w');
t_id = fopen('../results/time_ex3.txt', 'w');
