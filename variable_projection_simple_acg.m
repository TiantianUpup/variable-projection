function runhist = variable_projection_simple_acg(U0,V0,U_true,V_true,W_true,MA,vp_paras,cg_paras,paras)
    timect = cputime;
    m = paras.m;
    n = paras.n;
    r = paras.r;
    ...
    fprintf("variable_projection_simple_acg method, the initial objective value fval is %3.4f\n",fval_init);
    ...
    while (iter < itmax)
        ...
        runhist = cg_subproblem_simple(Aparas,cg_paras,paras,B0,0);
       ...
       %% check whether [A;B] is the descent direction
        ...
        for i=1:150
            ...
            if f_diff>0
                %if fval_pre-fval_cur>0
                flag=true;
                fprintf("iter=%d, backtracking stepsize selection successful, step length is %3.8f\n",iter,t);
                break;
            end
        end
        ...
        fprintf("variable_projection_gamma %d-th iteration =============================================================\n",iter);
