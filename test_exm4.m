...
for i=1:trial
    ...
    % u_4=U_true(:,4);
    % u_5=U_true(:,5);
    c_validate=(u_1'*u_2)/(norm(u_1)*norm(u_2));
    c_validate_1=(u_3'*u_2)/(norm(u_3)*norm(u_2));
    % c_validate_2=(u_3'*u_4)/(norm(u_3)*norm(u_4));
    % c_validate_3=(u_5'*u_4)/(norm(u_5)*norm(u_4));
    % fprintf("------------------------------ c_validate=%3.10f, c_validate_1=%3.10f, c_validate_2=%3.10f, c_validate_3=%3.10f ------------------------------\n",c_validate,c_validate_1,c_validate_2,c_validate_3);
    fprintf("------------------------------ c_validate=%3.10f, c_validate_1=%3.10f ------------------------------\n",c_validate,c_validate_1);
